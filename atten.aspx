<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_dayouv3h" %>
...
<div id="xr_xrc3" class="xr_ap xr_xri_ xr_xrc" style="width: 1290px; height: 1290px; overflow:hidden;">
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="ATTENDANCE MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="Attended" HeaderText="Attended" SortExpression="Attended" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                                      <asp:BoundField DataField="ScoolOpens" HeaderText="Scool Opened" SortExpression="ScoolOpens" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                                      <asp:BoundField DataField="Date" HeaderText="Next Term Resumes" SortExpression="Date">
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                                  </Columns>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT AttendanceTable.ID, StudentInfoTable.StudentFirstname + ' ' + StudentInfoTable.StudentLastName AS [Student Name], AttendanceTable.Attended, AttendanceTable.Date, AttendanceTable.ScoolOpens FROM AttendanceTable INNER JOIN StudentClassInitialTable ON AttendanceTable.StudentClassInitialID = StudentClassInitialTable.StudentClassInitialID INNER JOIN StudentInfoTable ON StudentClassInitialTable.StudentAdmissionID = StudentInfoTable.StudentAdmissionID"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  <td class="auto-style19">Select Student Name</td>
                                                  <td class="auto-style26">
                                                      <asp:DropDownList ID="CBStudent" class ="chosen-select" runat="server" AutoPostBack="True" Width="400px" DataSourceID="SqlDataSource1" DataTextField="Session Term Names" DataValueField="StudentClassInitialID">
                                                      </asp:DropDownList>
                                                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT SessionTable.SessionName + ' ' + TermTable.TermName + ' ' + ClassTable.Name + ' ' + StudentInfoTable.StudentFirstname + ' ' + StudentInfoTable.StudentLastName AS [Session Term Names], StudentClassInitialTable.StudentClassInitialID FROM SessionTermTable INNER JOIN SessionTable ON SessionTermTable.SessionNameID = SessionTable.ID INNER JOIN TermTable ON SessionTermTable.TermName = TermTable.ID INNER JOIN StudentClassInitialTable ON SessionTermTable.ID = StudentClassInitialTable.SessionTerm INNER JOIN StudentInfoTable ON StudentClassInitialTable.StudentAdmissionID = StudentInfoTable.StudentAdmissionID INNER JOIN ClassTable ON StudentClassInitialTable.ClassID = ClassTable.ID"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Attendance&nbsp;</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtAttend" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">School Opened</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtAttendSc" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Nex Term Scool Resumes</td>
                                                  <td class="auto-style26">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                                                      ...
                                                      <asp:TextBox ID="AttDate" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                  <td class="auto-style28" colspan="2">
                                                      <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SeDS" ForeColor="#333333" GridLines="None" ShowFooter="True" style="font-size: 13px" Width="1188px" PageSize="20">
                                                          <AlternatingRowStyle BackColor="White" />
                                                          <Columns>
                                                              <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" >
                                                              <HeaderStyle HorizontalAlign="Left" />
                                                              ...
                                                              <asp:BoundField DataField="ScoolOpens" HeaderText="School Opened" SortExpression="ScoolOpens" >
                                                              <HeaderStyle HorizontalAlign="Left" />
                                                              </asp:BoundField>
                                                              <asp:BoundField DataField="Date" HeaderText="Next Term Resumes" SortExpression="Date">
                                                              <HeaderStyle HorizontalAlign="Left" />
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT AttendanceTable.ID, StudentInfoTable.StudentFirstname + ' ' + StudentInfoTable.StudentLastName AS [Student Name], AttendanceTable.Attended, AttendanceTable.Date, AttendanceTable.ScoolOpens FROM AttendanceTable INNER JOIN StudentClassInitialTable ON AttendanceTable.StudentClassInitialID = StudentClassInitialTable.StudentClassInitialID INNER JOIN StudentInfoTable ON StudentClassInitialTable.StudentAdmissionID = StudentInfoTable.StudentAdmissionID"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
