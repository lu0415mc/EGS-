<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_h3bujgcs" %>
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="SUBJECT MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              &nbsp;<asp:Button ID="BtnCreate" runat="server" Text="Create" Height="26px" />
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT SubjectStatementTable.ID, ClassTable.Name, SubjectStatementTable.SubjectStatement, SubjectStatementTable.DateCreated FROM SubjectStatementTable INNER JOIN ClassTable ON SubjectStatementTable.ClassID = ClassTable.ID"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                          ...
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      <asp:DropDownList class ="chosen-select" ID="CBClass" runat="server" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="ID" Width="400px">
                                                      </asp:DropDownList>
                                                      <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM [ClassTable]"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Description</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtDescr" runat="server" Width="400px" TextMode="MultiLine"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                             ...
                             <ItemTemplate>
                                   <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/good.png" Text="Select" ToolTip="Select to edit"/>
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT SubjectStatementTable.ID, ClassTable.Name, SubjectStatementTable.SubjectStatement, SubjectStatementTable.DateCreated FROM SubjectStatementTable INNER JOIN ClassTable ON SubjectStatementTable.ClassID = ClassTable.ID"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
