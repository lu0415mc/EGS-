<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_wc0n3t5p" %>
         ...
         visible="true" align="right" class="auto-style1">
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [Name], [Description] FROM [SubjectTable]"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                          ...
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtSubjectName" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                             ...
                             <ItemTemplate>
                                   <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/good.png" Text="Select" ToolTip="Select to edit"/>
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [Name], [Description] FROM [SubjectTable]"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
