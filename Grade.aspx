<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_jw52cdis" %>
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="GRADE MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                          ...
                          <td>
                              ...
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="MinScore" HeaderText="MinScore" SortExpression="MinScore" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                                      <asp:BoundField DataField="MaxScore" HeaderText="MaxScore" SortExpression="MaxScore" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                             ...
                             <ItemTemplate>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [Grade], [MinScore], [MaxScore], [Remark], [DateCreated] FROM [GradeTable]"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  <td class="auto-style19">Grade</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtGradeID" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Min Score</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtMin" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Max Score</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtMax" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Remark</td>
                                                  <td class="auto-style26">
