<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_ia1yg3sb" %>
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="TERM MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                          ...
                          <td>
                              ...
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="TermName" HeaderText="Term" SortExpression="TermName" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                                  </Columns>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [TermName] FROM [TermTable]"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                          ...
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtTermName" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                  <td class="auto-style28" colspan="2">
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [TermName] FROM [TermTable]"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
