<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_jqw00yr5" %>
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="CLASS MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                          ...
                          <td>
                              ...
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="Name" HeaderText="Class Name" SortExpression="Name" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                                  </Columns>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM [ClassTable]"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                              ...
                              <table id="AETB1" runat="server" cellpadding="0" cellspacing="0" class="auto-style23" style="border-width: 1px; border-style: solid; border-top-left-radius: 20px; border-top-right-radius: 20px; background-color: white; font-size: 15px;" visible="false">
                                  <tr>
                                          ...
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtClassName" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Select Teacher</td>
                                                  <td class="auto-style26">
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      ...
                                                      <asp:TextBox ID="TextBox1" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                      ...
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/good.png" Text="Select" ToolTip="Edit"/>
                                  </ItemTemplate>
                                     </asp:TemplateField>
                                                          </Columns>
                                                          <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT ClassTable.ID, ClassTable.Name, StaffInfoTable.StaffLastName + ' ' + StaffInfoTable.StaffFirstName AS STAFF FROM ClassTable INNER JOIN StaffInfoTable ON ClassTable.StafID = StaffInfoTable.StaffID"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
