<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_fqhml11j" %>
...
<div class="xr_ap xr_pp">
 <!--[if lt IE 9]>
 <img class="xr_ap" src="index_htm_files/31.png" alt="" title="" style="left: -2px; top: -2px; width: 1304px; height: 1290px;"/>
 <![endif]-->
 <!--[if gte IE 9]><!-->
...
<div id="xr_xrc3" class="xr_ap xr_xri_ xr_xrc" style="width: 1290px; height: 1490px; overflow:hidden;">
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="STAFF MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:Button ID="BtnStaffDes" runat="server" Text="Staff Designation" />
                          </td>
                      </tr>
                      <tr>
                          <td>
                  
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="StaffID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT StaffInfoTable.SN, StaffInfoTable.StaffID, StaffInfoTable.StaffLastName + ' ' + StaffInfoTable.StaffFirstName AS [Staff Name], StaffInfoTable.Phone, StaffDesignationTable.Name, StaffInfoTable.DateCreated FROM StaffInfoTable INNER JOIN StaffDesignationTable ON StaffInfoTable.StaffRoleID = StaffDesignationTable.SN"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  <td class="auto-style19">Staff ID</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtStaffID" runat="server" Width="200px" ReadOnly="True"></asp:TextBox>
                                                  </td>
                                                  <td class="auto-style26">
                                                      last Name</td>
                                                  <td class="auto-style26">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      <asp:DropDownList ID="DropDownList2" class ="chosen-select" runat="server" Width="200px">
                                                  ...
                                                  <td class="auto-style26">
                                                      Role</td>
                                                  <td class="auto-style26">
                                                      <asp:DropDownList class ="chosen-select" ID="CBDes" runat="server" Width="200px" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="SN">
                                                      </asp:DropDownList>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  ...
                                                  <td class="auto-style26">
                                                      Password</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtPassword" placement="Minimun 6 character." runat="server" Width="200px" TextMode="Password"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  ...
                                                  <td class="auto-style26" colspan="3">
                                                      ...
                                                      <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [SN], [Name] FROM [StaffDesignationTable]"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                              <tr>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <asp:TextBox ID="DOB" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                          </td>
                                  </tr>
                              </table>
                              <br />
                      ...
                      <tr>
                          <td  style="position: absolute; top: 60px; right: 400px;">
                  
                                                      <table id="DesignationTB" class="auto-style5" runat ="server" visible ="false" style="background-color: #FFCC66">
                                                          <tr>
                                                              <td>Designation</td>
                                                              <td>
                                                          ...
                                                          <tr>
                                                              <td colspan="2">
                                                                  <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="SN" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" PageSize="5" ShowFooter="True" Width="443px">
                                                                      <AlternatingRowStyle BackColor="White" />
                                                                      <Columns>
                                                                          <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN">
                                                                          <HeaderStyle HorizontalAlign="Left" />
                                                                          </asp:BoundField>
                                                                          <asp:BoundField DataField="Name" HeaderText="Designation" SortExpression="Name">
                                                                          <HeaderStyle HorizontalAlign="Left" />
                                                                          </asp:BoundField>
                                                                          <asp:TemplateField>
                                          <ItemTemplate>
                                      ...
                                      <asp:ImageButton ID="ImageButton5" runat="server" CausesValidation="False" 
                                          CommandName="DeleteName" ImageUrl="~/images/del.png" Text="Select" 
                                          Tooltip="Delete" CommandArgument='<%#Eval("SN") %>'/>
                                                                  ...
                                                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [SN], [Name] FROM [StaffDesignationTable]"></asp:SqlDataSource>
                                                              </td>
                                                          </tr>
                                                      </table>
                          </td>
