<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_stxayws2" %>
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="FEES MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="FeesID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                                  <AlternatingRowStyle BackColor="White" />
                                  <Columns>
                                      <asp:BoundField DataField="FeesID" HeaderText="Fees ID" InsertVisible="False" ReadOnly="True" SortExpression="FeesID" >
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT FeesTable.FeesID, ClassTable.Name AS Class, FeesTable.Fees, FeesTable.Amount FROM FeesTable INNER JOIN ClassTable ON FeesTable.Class = ClassTable.ID"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  <td class="auto-style19">Select Class</td>
                                                  <td class="auto-style26">
                                                      <asp:DropDownList ID="CBClass" class ="chosen-select" runat="server" AutoPostBack="True" Width="400px" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="ID">
                                                      </asp:DropDownList>
                                                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [Name], [ID] FROM [ClassTable]"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Fees Name</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtFees" runat="server" Width="400px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Amount</td>
                                                  <td class="auto-style26">
                                              ...
                                              <tr>
                                                  <td class="auto-style28" colspan="2">
                                                      <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="FeesID" DataSourceID="SeDS" ForeColor="#333333" GridLines="None" ShowFooter="True" style="font-size: 13px" Width="1188px" PageSize="20">
                                                          <AlternatingRowStyle BackColor="White" />
                                                          <Columns>
                                                              <asp:BoundField DataField="FeesID" HeaderText="Fees ID" InsertVisible="False" ReadOnly="True" SortExpression="FeesID" >
                                                              <HeaderStyle HorizontalAlign="Left" />
                             ...
                             <ItemTemplate>
                                   <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/good.png" Text="Select" ToolTip="Select to edit"/>
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT        FeesTable.FeesID, ClassTable.Name AS Class, FeesTable.Fees, FeesTable.Amount
FROM            FeesTable INNER JOIN
                         ClassTable ON FeesTable.Class = ClassTable.ID"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
