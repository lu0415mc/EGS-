<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_u5agrotf" %>
...
<div id="xr_xrc3" class="xr_ap xr_xri_ xr_xrc" style="width: 1290px; height: 1890px; overflow:hidden;">
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="SOCIAL HABIT AND MANIPULATIVE SKILLS"></asp:Label>
                              <hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:Button ID="Btnrating" runat="server" Text="Enter Rate" />
                          </td>
                      </tr>
                      <tr>
                          <td>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT HabitTable.ID, HabitTable.Habit, StaffInfoTable.StaffLastName + ' ' + StaffInfoTable.StaffFirstName AS [Staff Name], HabitTable.DateCreated FROM HabitTable INNER JOIN StaffInfoTable ON HabitTable.StaffID = StaffInfoTable.StaffID"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  <td class="auto-style19">Work Habit And Behaviour&nbsp;</td>
                                                  <td class="auto-style26">
                                                      <asp:TextBox ID="txtWorkHabit" runat="server" Width="400px" TextMode="MultiLine"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                  <td class="auto-style28" colspan="2">
                                                      <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SeDS" ForeColor="#333333" GridLines="None" ShowFooter="True" style="font-size: 13px" Width="1188px" PageSize="19">
                                                          <AlternatingRowStyle BackColor="White" />
                                                          <Columns>
                                                              <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" >
                                                              <HeaderStyle HorizontalAlign="Left" />
                             ...
                             <ItemTemplate>
                                   <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/good.png" Text="Select" ToolTip="Select to edit"/>
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT HabitTable.ID, HabitTable.Habit, StaffInfoTable.StaffLastName + ' ' + StaffInfoTable.StaffFirstName AS [Staff Name], HabitTable.DateCreated FROM HabitTable INNER JOIN StaffInfoTable ON HabitTable.StaffID = StaffInfoTable.StaffID"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
                      ...
                      <tr style="position: absolute; top: 60px; right: 450px;">
                          <td>
                                                      ...
                                                      <table id="DesignationTB" class="auto-style5" runat ="server" visible ="false" style="background-color: #FFCC66">
                                                          ...
                                                          <tr>
                                                              <td colspan="2">
                                                                  <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" ShowFooter="True" Width="443px">
                                                                      <AlternatingRowStyle BackColor="White" />
                                                                      <Columns>
                                                                          <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID">
                                                                          </asp:BoundField>
                                      ...
                                      <asp:ImageButton ID="ImageButton5" runat="server" CausesValidation="False" 
                                          ...
                                          Tooltip="Delete" CommandArgument='<%#Eval("ID") %>'/>
                                                                  ...
                                                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [ID], [Rating] FROM [RatingTable]"></asp:SqlDataSource>
                                                              </td>
                                                          </tr>
                                                      </table>
                          </td>
