<%@ page language="VB" autoeventwireup="false" inherits="home, App_Web_lrcjaoar" %>
...
<head>
 ...
 <title>Head Teacher Statement</title>
...
<div id="xr_xrc3" class="xr_ap xr_xri_ xr_xrc" style="width: 1290px; height: 1590px; overflow:hidden;">
         ...
         visible="true" align="right" class="auto-style1">
                      <tr>
                          <td class="auto-style3">
                              ...
                              <strong>
                              <asp:Label ID="Label9" runat="server" CssClass="auto-style4" Text="TEACHER AND HEAD TECHER STATEMENT MANAGEMENT"></asp:Label>
                              <hr />
                              </strong>
                          ...
                          <td>
                              ...
                              <asp:GridView ID="GridView1" runat="server" Width="1203px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SessionDS" ForeColor="#333333" GridLines="None" PageSize="25" ShowFooter="True">
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="SubjectStatement" HeaderText="Remark" SortExpression="SubjectStatement" >
                                      <HeaderStyle HorizontalAlign="Left" />
                                      </asp:BoundField>
                              ...
                              <asp:SqlDataSource ID="SessionDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT TeacherHeadStatementTable.ID, StaffDesignationTable.Name AS Role, TeacherHeadStatementTable.SubjectStatement, TeacherHeadStatementTable.DateCreated FROM TeacherHeadStatementTable INNER JOIN StaffDesignationTable ON TeacherHeadStatementTable.StaffRole = StaffDesignationTable.SN"></asp:SqlDataSource>
                          </td>
                      </tr>
                      <tr>
                          <td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          <table id="tbl-format-c" align="center" cellpadding="5" cellspacing="5" class="auto-style10" style="width: 1206px;">
                                              <tr>
                                                  <td class="auto-style19">Staff Role</td>
                                                  <td class="auto-style26">
                                                      <asp:DropDownList class ="chosen-select" ID="CBDesignation" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource3" DataTextField="Name" DataValueField="SN" Width="400px">
                                                      </asp:DropDownList>
                                                      <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT [SN], [Name] FROM [StaffDesignationTable]"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td class="auto-style19">Statement</td>
                                                  <td class="auto-style26">
                             ...
                             <ItemTemplate>
                                   <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/good.png" Text="Select" ToolTip="Select to edit"/>
                                                      ...
                                                      <asp:SqlDataSource ID="SeDS" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolGradeConnectionString %>" SelectCommand="SELECT TeacherHeadStatementTable.ID, StaffDesignationTable.Name AS Role, TeacherHeadStatementTable.SubjectStatement, TeacherHeadStatementTable.DateCreated FROM TeacherHeadStatementTable INNER JOIN StaffDesignationTable ON TeacherHeadStatementTable.StaffRole = StaffDesignationTable.SN"></asp:SqlDataSource>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
